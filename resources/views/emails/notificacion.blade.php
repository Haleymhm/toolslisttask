    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <div class="error-page">
                <h2 class="headline text-yellow">Directiva 500</h2>
                <div class="error-content">
                <h3><i class="fa fa-warning text-yellow"></i><strong> Oops! ha ocurrido un error interno.</strong></h3>
                <p>Por favor coomunicate con el administrador del sistema.</p>
                <a href="/actividad"><strong>Ir al inico</strong></a>
                </div>
                <!-- /.error-content -->
            </div>
        </div>
