...
<html>
    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <h2 class="headline text-yellow">Directiva 404</h2>
            <div class="error-content">
                <h3><i class="fa fa-warning text-yellow"></i><strong> Oops! la ruta solicitada no ha sido encontrada.</strong></h3>
                <p>Por favor realice de nuevo la busqueda.</p>
