...
<html>
    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
                        ...
                        <nav class="navbar navbar-static-top" role="navigation">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ asset('upload/avatar') }}/no-session.jpg" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Sessi&oacute;n Expirada</span>
                                </a>
                                </li>
                            </ul>
                            </div>
            ...
            <h2 class="headline text-red">Directiva 419</h2>
            <div class="error-content">
                <h3><i class="fa fa-expeditedssl text-yellow"></i> <strong>Tu sessi&oacute;n a expirado.</strong></h3>
                <p>Por favor complete nuevamente sus datos para ingresar al sistema.</p>
                <a href="/home" class="text-light-blue"><strong>Ir la Login</strong> </a>
            </div>
            <!-- /.error-content -->
            </div>
        </div>
