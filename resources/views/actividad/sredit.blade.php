		...
		<div class="box-header with-border">
            @foreach($tipoactividads as $tipoact)
                                  ...
                                  <h3 class="box-title"><strong>
                                    ...
                                    @if($tipoact->tipoactdescrip!='')
                                        <a tabindex="0" role="button" data-toggle="popover"
                                        data-placement="bottom"
                                        data-trigger="focus"
                                        data-content="{{$tipoact->tipoactdescrip}}" class="no-print">
            ...
            @endforeach
							@if ($actividad->actividadstatus  == "A")
									<span id="status_span" class="badge label-primary">&nbsp;&nbsp;&nbsp;&nbsp;Abierta&nbsp;&nbsp;&nbsp;&nbsp;</span>
							@elseif ($actividad->actividadstatus  == "X")
									<span id="status_span" class="badge label-default">Cerrada</span>
							@elseif ($actividad->actividadstatus  == "C")
									<span id="status_span" class="badge label-success">&nbsp;&nbsp;Cerrada&nbsp;&nbsp;</span>
                            @endif
				...
				@foreach ($contenidos as $key => $conte)
					...
					@if ($conte->tipodato == "text")
						<div class="form-group col-md-6 col-sd-12 col-xs-12">
							<div class="col-md-12 col-sd-12 col-xs-12">
						      ...
						      <input type="text" class="form-control " id="tipoActividadNombre" name="valortext[]" value="{{$conte->valortexto}}" onkeypress="inputCharacters()"/>
						    </div>
					...
					@if ($conte->tipodato == "textarea")
						<div class="form-group col-md-12 col-sd-12 col-xs-12">
							<div class="col-md-12 col-sd-12 col-xs-12">
							    <label for="tipoActividadDescrip" style="color:black;">{{$conte->etiqueta}}</label>
							    <textarea name="valortext[]" class="form-control" id="tipoActividadNombre" onkeyup="textAreaAdjust(this)" style="overflow:hidden">{{$conte->valortexto}}</textarea>
					    	</div>
					      <input type="hidden" name="registro[]" value="{{$conte->id}}">
					      <input type="hidden" name="tipodato[]" value="{{$conte->tipodato}}">
					  </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <label style="color:black;"> {{$conte->etiqueta}}</label> &nbsp
