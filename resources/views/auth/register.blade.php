...
<div class="register-box">
  <div class="register-logo">
    <h1 style="font-family: 'Mina', sans-serif;font-size:36px;font-weight:bold;">
        {{ config('app.name', 'BuntTech 2019') }}
    </h1>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">{{ __('Register') }} para nuevos usuarios </p>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" required> Esta de acuerdo con los <a href="#">terminos</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
