...
<div class="col-xs-12" style=" padding-top:10px">
		<div class="box box-solid with-border">
			<div class="box-header with-border"> <h3 class="box-title">Registro de Tipos de Actividades</h3> </div>
		<!-- /.box-header -->
		<!-- form start -->
			<form class="form-horizontal" action="{{ route('tipoact.store') }}" autocomplete="on" method="POST">
				@csrf
				...
				<div class="box-body">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-sm-10">
				        <textarea class="form-control" id="tipoActividadDescrip" name="tipoactdescrip" onkeyup="textAreaAdjust(this)" style="overflow:hidden"> </textarea>
				      </div>
				    </div>
					...
					<label for="tipoActividadStatus" class="col-sm-2 control-label">Color</label>
				      <div class="col-sm-2">
				        <input type="color" name="tipoactcolor" class="form-control" required />
					  </div>
				    </div>
